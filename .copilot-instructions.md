...
⚠️ **If adding URL-based features:**
...
**When adding logging:**
- ✅ Use `anonymize_ip()` for IP addresses
- ✅ Use `simplify_user_agent()` for User-Agent
- ❌ Never log full IP addresses
- ❌ Never log detailed User-Agent strings
...
- ✅ **Create a unit test for EVERY implemented feature** (pytest)
...
**When to Write Tests:**
- ✅ New API endpoints → Test all HTTP methods and status codes
- ✅ New database operations → Test CRUD operations
- ✅ New utility functions → Test edge cases and error handling
